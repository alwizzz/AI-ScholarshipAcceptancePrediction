...
class Prediction extends Model
{
    ...
    public static function seed(){
        ...
        foreach($items as $item){
            ...
            $beasiswa_prediction = ($positive_probability >= $negative_probability) ? true : false;
            $is_accurate = ($beasiswa_prediction == $item->beasiswa) ? true : false;
            Prediction::create([
                'item_id' => $item_id,
                'positive_probability' => $positive_probability,
                'negative_probability' => $negative_probability,
                'beasiswa_prediction' => $beasiswa_prediction,
                'beasiswa_real' => $item->beasiswa,
